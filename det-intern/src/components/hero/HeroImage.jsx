...
const HeroImage = () => {
  return (
    <div className="relative w-full flex items-center justify-center lg:justify-end">
      ...
      <div className="absolute inset-0 m-auto w-[90%] h-[90%] rounded-3xl border border-secondary/10 rotate-3 pointer-events-none" />
      ...
      >
        <img
          ...
          className="w-full h-[360px] sm:h-[440px] lg:h-[500px] object-cover object-center group-hover:scale-105 transition-transform duration-700 ease-out"
          loading="eager"
        />
